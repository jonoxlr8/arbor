  ...
  return <section className="plan-customization" aria-labelledby="customize-heading">
    ...
    <div className="satellite-options">
      <fieldset disabled={disabled} aria-describedby="technology-help">
        <legend><span className="satellite-icon satellite-tech" aria-hidden="true"><ArborIdentityIcon glyph="circuit"/></span>Technology <small>Optional</small></legend>
      ...
      <fieldset disabled={disabled} aria-describedby="bitcoin-help">
        <legend><span className="satellite-icon satellite-bitcoin" aria-hidden="true"><ArborIdentityIcon glyph="coin"/></span>Bitcoin <small>Optional</small></legend>
...
export function FinalPlanReview({ value }: { value: PlanV2 }) {
  ...
  return <section className="final-plan-review" aria-labelledby="final-plan-heading">
    ...
    <h2 id="final-plan-heading" className="choice-heading">Your plan is ready</h2>
