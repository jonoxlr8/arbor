...
export default function SignupPending({ email, loading, cooldown, resendDisabled, confirmation, error, onResend, onDifferentEmail }: {
  ...
  return <section className="arbor-panel mx-auto h-fit w-full min-w-0 max-w-md" aria-labelledby="signup-pending-title">
    ...
    <p className="mt-4 text-sm leading-6 text-slate-600">Open the email and select “Continue to email confirmation” to finish creating your Arbor account.</p>
    ...
    <button type="button" disabled={resendDisabled} onClick={onResend} className="mt-6 min-h-12 w-full rounded-xl bg-emerald-700 px-4 py-3 font-semibold text-white disabled:opacity-60">
