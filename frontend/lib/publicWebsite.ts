...
export const publicFaqs = [
  ...
  ['Where do I actually invest?', 'You open and manage accounts directly with your chosen provider. Arbor explains supported implementation options, but does not rank providers or open accounts for you. Provider fees, eligibility and availability still apply.'],
  ...
  ['What is the difference between Free and Plus?', 'Free is designed for building and understanding a plan, with basic projections, next steps and 10 Ask Arbor questions per month. Plus adds full Ask Arbor access, contribution planning and profile editing, with Portfolio tracking planned. During private beta, all authenticated beta users receive Plus free, without a credit card or billing date. Planned launch pricing is ₱399/month or ₱3,990/year; there is no checkout today.'],
